...
async function startAdrian() {
    ...
    const conn = connConnect({
        ...
        browser: ['Nobita-MD','Safari','1.0.0'],
   ...
   // anticall auto block
    ...
    conn.ev.on('messages.upsert', async chatUpdate => {
        ...
        require("./koneko")(conn, m, chatUpdate, store)
        } catch (err) {
            console.log(err)
        }
    })
	...
	conn.ev.on("groups.update", async (json) => {
				...
				conn.sendMessage(res.id, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            sourceUrl: "https://instagram.com/nobita7.io",
                            mediaType: 1,
        ...
        try {
            ...
            for (let num of participants) {
               ...
               if (anu.action == 'add') {
                 let ggnob = `https://api.lolhuman.xyz/api/base/welcome?apikey=62c6a23a508bba5ed2336794&img1=${ppuser}&img2=${ppgroup}&background=https://telegra.ph/file/e2514bcc337f368a021f1.png&username=${num.split}&member=${participants}&groupname=${metadata.subject}`
...
try{
		...
		} else if (connection === "open") { conn.sendMessage(owo + "@s.whatsapp.net", { text: `*Bot Started!*\n\n• *Nobita-MD V1.3*\n\n*Buy Panel Di Nobita Aja :3*\n\n*YouTube:*\nhttps://youtube.com/c/nobita404` }); }
